...
fun MiniPlayer(
    ...
    FloatingContainer(modifier = modifier.fillMaxWidth()) { // Use FloatingContainer
        Row( 
            modifier = Modifier
                .fillMaxWidth()
                .padding(8.dp),
            ...
            IconButton(onClick = onPlayPauseClick) {
                Icon(
                    imageVector = if (isPlaying) Icons.Filled.Settings else Icons.Filled.PlayArrow, // Replace Settings with Pause icon when implemented
